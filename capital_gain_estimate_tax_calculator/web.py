...
def _render_tax_section(
    ...
    .tax-workflow-actions #switch-guidance-button {{ grid-column:1; margin:0 }} .tax-workflow-actions .formula-action {{ grid-column:2 }} .tax-workflow-actions .formula-action button {{ background:#526d82 }}
    .tax-workflow-actions #open-local-settings {{ grid-column:3; justify-self:start; margin:0 }} .tax-workflow-actions #guidance-profile-note {{ grid-column:1/-1; margin:0 }}
    @media(max-width:800px) {{ .tax-workflow-actions {{ grid-template-columns:1fr }} .tax-workflow-actions .guidance-form {{ grid-column:1; display:grid; grid-template-columns:1fr }} .tax-workflow-actions #switch-guidance-button,.tax-workflow-actions .formula-action,.tax-workflow-actions #open-local-settings {{ grid-column:1; width:100% }} .tax-workflow-actions .formula-action button {{ width:100% }} }}
