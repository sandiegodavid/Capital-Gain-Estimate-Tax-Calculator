...
def create_formats(workbook: xlsxwriter.Workbook) -> FormatMap:
    ...
    return {
        ...
        "subtitle": workbook.add_format(
            {"font_name": "Aptos", "font_size": 10, "italic": True, "font_color": "#5B6573"}
        ),
        ...
        "currency_formula": workbook.add_format(
            {**body, "font_color": "#008000", "align": "right", "num_format": "$#,##0.00;[Red]($#,##0.00);-"}
        ),
        "whole_formula": workbook.add_format(
            {**body, "font_color": "#008000", "align": "right", "num_format": "$#,##0;[Red]($#,##0);-"}
        ),
        ...
        "audit_label": workbook.add_format(
            {
                "font_name": "Aptos",
                "font_size": 10,
                "bold": True,
        ...
        "audit_status": workbook.add_format(
            {"font_name": "Aptos", "font_size": 14, "bold": True, "font_color": "#008000", "align": "center"}
        ),
        "total": workbook.add_format({**body, "bold": True}),
        "total_whole": workbook.add_format(
            {**body, "bold": True, "align": "right", "num_format": "$#,##0;[Red]($#,##0);-"}
        ),
        ...
        "legend": workbook.add_format(
            {"font_name": "Aptos", "font_size": 10, "bold": True, "font_color": "#15324B", "bg_color": "#DCEAF7"}
        ),
